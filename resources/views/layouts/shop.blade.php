...
<body class="theme-shell font-sans antialiased" data-theme="{{ $websiteThemePreset }}">
                    ...
                    <button
                        ...
                        x-data="{
                            ...
                            toggle() {
                                ...
                                localStorage.setItem('color-mode', this.dark ? 'dark' : 'light');
                            }
                        }"
                        @click="toggle()"
                    >
